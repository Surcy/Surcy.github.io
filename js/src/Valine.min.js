  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      function c(e, t, n, r) {
        if (((n = g(n)), 'href' === t || 'src' === t)) {
          ...
          if (((I.lastIndex = 0), I.test(n) && ((M.lastIndex = 0), M.test(n))))
            return ''
    ...
    function(e, t, n) {
      ...
      function a(e, t) {
          ...
          if (!1 !== o || '=' !== g)
            if (
              ...
              if (/\s|\n|\t/.test(g)) {
                if (((e = e.replace(/\s|\n|\t/g, ' ')), !1 === o)) {
                  if (-1 === (h = s(e, c))) {
                    ;(f = d.trim(e.slice(r, c))), n(f), (o = !1), (r = c + 1)
                    continue
                  }
                  c = h - 1
                  continue
        ...
        return (
          r < e.length &&
            (!1 === o ? n(e.slice(r)) : n(o, u(d.trim(e.slice(r))))),
          d.trim(i.join(' '))
        )
      }
      function s(e, t) {
    ...
    function(e, t, n) {
      ...
      var y = {
        ...
        k = {
          'zh-cn': {
            head: { nick: '昵称', mail: '邮箱', link: '网址(http://)' },
            tips: {
              comments: '评论',
              sofa: '还没有评论哦，快来抢沙发吧~',
              busy: '还在提交中，请稍候...',
        ...
        w = [
          ...
          { name: 'lips', code: '1F444' },
          { name: 'tongue', code: '1F445' },
          { name: 'point_up_2', code: '1F446' },
          { name: 'point_down', code: '1F447' },
          { name: 'point_left', code: '1F448' },
          { name: 'point_right', code: '1F449' },
          { name: 'facepunch', code: '1F44A' },
          { name: 'wave', code: '1F44B' },
          { name: 'ok_hand', code: '1F44C' },
          { name: '+1', code: '1F44D' },
          { name: '-1', code: '1F44E' },
          { name: 'clap', code: '1F44F' },
          { name: 'cupid', code: '1F498' },
          { name: 'sparkling_heart', code: '1F496' },
          { name: 'open_hands', code: '1F450' },
          { name: 'grinning', code: '1F600' },
          { name: 'grin', code: '1F601' },
          { name: 'joy', code: '1F602' },
          { name: 'smiley', code: '1F603' },
          { name: 'smile', code: '1F604' },
          { name: 'sweat_smile', code: '1F605' },
          { name: 'laughing', code: '1F606' },
          { name: 'innocent', code: '1F607' },
          { name: 'smiling_imp', code: '1F608' },
          { name: 'wink', code: '1F609' },
          { name: 'blush', code: '1F60A' },
          { name: 'yum', code: '1F60B' },
          { name: 'relieved', code: '1F60C' },
          { name: 'heart_eyes', code: '1F60D' },
          { name: 'sunglasses', code: '1F60E' },
          { name: 'smirk', code: '1F60F' },
          { name: 'neutral_face', code: '1F610' },
          { name: 'expressionless', code: '1F611' },
          { name: 'unamused', code: '1F612' },
          { name: 'sweat', code: '1F613' },
          { name: 'pensive', code: '1F614' },
          { name: 'confused', code: '1F615' },
          { name: 'confounded', code: '1F616' },
          { name: 'kissing', code: '1F617' },
          { name: 'kissing_heart', code: '1F618' },
          { name: 'kissing_smiling_eyes', code: '1F619' },
          { name: 'kissing_closed_eyes', code: '1F61A' },
          { name: 'stuck_out_tongue', code: '1F61B' },
          { name: 'stuck_out_tongue_winking_eye', code: '1F61C' },
          { name: 'stuck_out_tongue_closed_eyes', code: '1F61D' },
          { name: 'disappointed', code: '1F61E' },
          { name: 'worried', code: '1F61F' },
          { name: 'angry', code: '1F620' },
          { name: 'rage', code: '1F621' },
          { name: 'cry', code: '1F622' },
          { name: 'persevere', code: '1F623' },
          { name: 'triumph', code: '1F624' },
          { name: 'disappointed_relieved', code: '1F625' },
          { name: 'frowning', code: '1F626' },
          { name: 'anguished', code: '1F627' },
          { name: 'fearful', code: '1F628' },
          { name: 'weary', code: '1F629' },
          { name: 'sleepy', code: '1F62A' },
          { name: 'tired_face', code: '1F62B' },
          { name: 'grimacing', code: '1F62C' },
          { name: 'sob', code: '1F62D' },
          { name: 'open_mouth', code: '1F62E' },
          { name: 'hushed', code: '1F62F' },
          { name: 'cold_sweat', code: '1F630' },
          { name: 'scream', code: '1F631' },
          { name: 'astonished', code: '1F632' },
          { name: 'flushed', code: '1F633' },
          { name: 'sleeping', code: '1F634' },
          { name: 'dizzy_face', code: '1F635' },
          { name: 'no_mouth', code: '1F636' },
          { name: 'mask', code: '1F637' },
            ...
            s(e, [
                  ...
                  try {
                    ...
                    if (((e.pageSize = isNaN(s) ? 10 : s < 1 ? 10 : s), !O)) {
                      ...
                      var c = e.app_id || e.appId,
                        ...
                        p = ['cn', 'us']
                      if (((d = p.indexOf(d) > -1 ? d : p[0]), !c || !u))
                        throw 100
                      l.init({ appId: c, appKey: u, region: d }),
                        (O = !0),
                        (t.v = l)
                      for (
                    ...
                    if (
                      !(v =
                        '[object HTMLDivElement]' === {}.toString.call(v)
                          ? v
                          : m[m.length - 1] || null)
                    )
                      throw 99
                    ;(t.el = v), t.el.classList.add('v')
                    var b = {
                        nick:
                        ...
                        link:
                          ...
                          t.locale.head.link +
                          '" class="vlink vinput" type="text">'
                      },
                      x = (0 == e.guest_info.length
                        ? ['nick', 'mail', 'link']
                        : e.guest_info
                      ).map(function(e) {
                        return b[e]
                    ...
                    t.el.innerHTML =
                      ...
                      '">' +
                      x.join('') +
                      '</div><div class="vedit"><textarea class="veditor vinput" placeholder="' +
                      y +
                      '"></textarea><div class="vctrl"><span class="vemoji-btn">Emoji</span> | <span class="vpreview-btn">Preview</span></div><div class="vemojis"  style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-60" title="MarkDown is supported"><a href="https://segmentfault.com/markdown" target="_blank">Markdown</a> is supported<div class="vlimit"></div></div><div class="col col-40 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' +
                      t.locale.ctrl.reply +
                      '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><ul class="vlist"></ul><div class="vempty" style="display:none;"></div><div class="vpage txt-center" ></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v1.1.9-beta9</div></div>'
                    var w = t.el.querySelector('.vempty')
                    t.nodata = {
                      show: function(e) {
                        return (
                          (w.innerHTML = e || t.locale.tips.sofa),
                    ...
                    t.loading = {
                      show: function(e) {
                        ...
                        return (
                          e ? F.insertBefore($, n[0]) : F.appendChild($),
                          t.nodata.hide(),
                          t
                        )
                      },
                      hide: function() {
                        ...
                        return (
                          e && F.removeChild(e),
                          0 === F.querySelectorAll('.vcard').length &&
                            t.nodata.show(),
                          t
                        )
                      }
                    ...
                    ;(t.alert = {
                      show: function(e) {
                        ...
                        var n = C.querySelector('.vbtns'),
                          r =
                            ...
                            ((e && e.ctxt) || t.locale.ctrl.cancel) +
                            '</button>',
                          i =
                            '<button class="vsure vbtn">' +
                            ((e && e.otxt) || t.locale.ctrl.sure) +
                            '</button>'
                        if (
                          ((n.innerHTML = '' + r + (e && e.type && i)),
                          B.on('click', C.querySelector('.vcancel'), function(
                            e
                          ) {
                            t.alert.hide()
                          }),
                      ...
                      hide: function() {
                        return C.setAttribute('style', 'display:none;'), t
                      }
                    }),
                      t.el && t.bind(e)
                  } catch (e) {
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  101 == e
                    ...
                    : ((n =
                        'number' == typeof e
                          ? 'Code ' + e + ': ' + (t.locale.error[e] || e)
                          : e),
                      t.el &&
                        t.nodata.show(
                          '<pre style="text-align:left;">' + n + '</pre>'
                        ),
                      console)
                }
              },
              {
                ...
                value: function(e, t) {
                  ...
                  return (
                    (t = t || {}),
                    (k[e] =
                      JSON.stringify(Object.keys(k['zh-cn'])) ==
              ...
              },
              {
                ...
                value: function(e) {
                  for (
                    var t = this,
                      n = t.el.querySelector('.vemojis'),
                      r = t.el.querySelector('.vemoji-btn'),
                      i = t.el.querySelector('.vpreview'),
                      s = function(e) {
                        var n = 'comment',
                          r = e.value || '',
                          o = r.substring(0, 1e4)
                        ;(t.el.querySelector('.vlimit').innerHTML =
                          '' == r
                            ? ''
                            : t.locale.tips.limit.replace(
                                '%d',
                                1e4 - o.length
                              )),
                          (y[n] = x.process((0, d.default)(o))),
                          (i.innerHTML = y[n]),
                          (e.value = o)
                      },
                      ...
                      p = function() {
                        ...
                        for (var o = ''; ++r < i; ) {
                          ...
                          if (!isFinite(a) || a < 0 || a > 1114111 || u(a) != a)
                  ...
                  for (var A in k)
                    k.hasOwnProperty(A) &&
                      (function() {
                        ...
                        ;(b[e] = n),
                          B.on('input', n, function(t) {
                            'comment' === e
                              ? s(n)
                              : (y[e] = o(
                                  n.value.replace(/(^\s*)|(\s*$)/g, '')
                                ))
                          })
                      })()
                  var O = t.el.querySelector('.vpreview-btn')
                  B.on('click', O, function(e) {
                    if ('' != y.comment) {
                      O.getAttribute('v')
                        ? (O.removeAttribute('v'),
                          i.setAttribute('style', 'display:none'))
                    ...
                    .then(function(e) {
                      e > 0
                        ? (t.el
                          ...
                          (t.el.querySelector('.vcount').innerHTML =
                            '<span class="vnum">' +
                            e +
                            '</span> ' +
                  ...
                  var T = function(e, n) {
                      ...
                      var i = S.hide
                          ? ''
                          : '<img class="vimg" src=\'' +
                            (S.cdn + (0, c.default)(e.get('mail')) + S.params) +
                            "'>",
                        o = (0, f.default)(e.get('ua')),
                        a =
                          '<span class="vsys">' +
                          o.browser +
                          ' ' +
                        ...
                        u = e.get('link') || ''
                      ;(l = u
                        ? '<a class="vname" rel="nofollow" href="' +
                          u +
                          '" target="_blank" >' +
                          e.get('nick') +
                          '</a>'
                        : '<span class="vname">' + e.get('nick') + '</span>'),
                        (r.innerHTML =
                          i +
                          '<section><div class="vhead">' +
                          l +
                          ' ' +
                          a +
                          ' ' +
                          s +
                          '</div><div class="vcontent">' +
                          e.get('comment') +
                          '</div><div class="vfooter"><span class="vtime">' +
                          (0, g.default)(e.get('createdAt'), t.locale) +
                          "</span><span rid='" +
                          e.id +
                          "' at='@" +
                          e.get('nick') +
                          ...
                          '</span><div></section>')
                      for (
                        var d = r.querySelector('.vat'),
                          p = r.querySelectorAll('a'),
                          h = 0,
                          v = p.length;
                        h < v;
                        h++
                  ...
                  var q = function() {
                    ...
                    P = function(e) {
                      ...
                      if (
                        ((y.nick = '' == y.nick ? 'Anonymous' : y.nick),
                        y.comment.indexOf(M.at) > -1 && '' != M.at)
                      ) {
                        var n =
                          '<a class="at" href=\'#' +
                          M.rid +
                    ...
                    U = function() {
                      j.setAttribute('disabled', !0), t.loading.show(!0)
                      var e = t.v.Object.extend('Comment')
                      ;(y.url = decodeURI(_)), (y.insertedAt = new Date())
                      var n = new e()
                      for (var r in y)
                      ...
                      n.setACL(R()),
                        n
                          ...
                          .then(function(e) {
                            ...
                            try {
                              n
                                ? ((r = Number(n.innerText) + 1),
                                  (n.innerText = r))
                                : (t.el.querySelector('.vcount').innerHTML =
                                    '<span class="num">1</span> ' +
                                    t.locale.tips.comments),
                                T(e),
                                y.mail && W({ username: y.nick, mail: y.mail }),
                                M.at &&
                                  M.rmail &&
                                  t.notify &&
                                  D({
                    ...
                    D = function e(n) {
                      t.v.User.requestPasswordReset(n.mail)
                        .then(function(e) {})
                        .catch(function(r) {
                          1 == r.code
                            ? t.alert.show({
                  ...
                  B.off('click', j, P),
                    B.on('click', j, P),
                    B.on('keyup', document, function(e) {
      ...
      var M = /[&<>"'`\\]/g,
        ...
        z = {
          ...
          link: function(e) {
            return (
              (e =
                e.length > 0 && (/^(http|https)/.test(e) ? e : 'http://' + e)),
              {
                k: /(http|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:\/~\+#]*[\w\-\@?^=%&amp;\/~\+#])?/.test(
                  e
                ),
                v: e
              }
    ...
    function(e, t, n) {
      ...
      function r(e) {
        ...
        r.Mobile
          ? (r.Mobile = !(t.indexOf('iPad') > -1))
          : o.showModalDialog && o.chrome && (r[360] = !0)
        var i = {
        ...
        ;(n.osVersion = ''),
          u[n.os] &&
            ((n.osVersion = u[n.os]()), n.osVersion == t && (n.osVersion = ''))
        var d = {
          Safari: function() {
        ...
        ;(n.version = ''),
          d[n.browser] &&
            ((n.version = d[n.browser]()), n.version == t && (n.version = '')),
          'Edge' == n.browser
            ? (n.engine = 'EdgeHTML')
            : 'Chrome' == n.browser && parseInt(n.version) > 27
            ? (n.engine = 'Blink')
            : 'Opera' == n.browser && parseInt(n.version) > 12
            ? (n.engine = 'Blink')
            : 'Yandex' == n.browser
            ? (n.engine = 'Blink')
            : void 0 == n.browser && (n.browser = 'Unknow App')
      }
      function i(e) {
        return new r(e)
      }
    ...
    function(e, t, n) {
      ...
      !(function(i) {
        ...
        function v(e, t) {
          ...
          return (
            (r = p(o.concat(h(t)), 512 + 8 * t.length)), f(p(a.concat(r), 640))
          )
        }
        function m(e) {
          var t,
      ...
      ;(function(t) {
        ;(function() {
          ...
          ;(d.bullet = /(?:[*+-]|\d+\.)/),
            ...
            (d.list = s(d.list)(/bull/g, d.bullet)(
              'hr',
              '\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))'
            )('def', '\\n+(?=' + d.def.source + ')')()),
            ...
            (d.paragraph = s(d.paragraph)('hr', d.hr)('heading', d.heading)(
              'lheading',
              d.lheading
            )('blockquote', d.blockquote)('tag', '<' + d._tag)('def', d.def)()),
            (d.normal = c({}, d)),
            (d.gfm = c({}, d.normal, {
              fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,
              paragraph: /^/,
            ...
            (t.prototype.token = function(e, t, n) {
              for (
                var r, i, o, a, s, l, c, u, p, e = e.replace(/^ +$/gm, '');
                e;
            ...
            (n.prototype.output = function(e) {
              for (var t, n, r, i, a = ''; e; )
                if ((i = this.rules.escape.exec(e)))
                  (e = e.substring(i[0].length)), (a += i[1])
                  ...
                  if ((i = this.rules.tag.exec(e)))
                    ...
                    (e = e.substring(i[0].length)),
                      (this.inLink = !0),
                      (a += this.outputLink(i, { href: i[2], title: i[3] })),
                      (this.inLink = !1)
                  else if (
        ...
        return s(e, function(e, t, n, s, c) {
          ...
          if (
            (!0 === u
              ...
              : 'function' == typeof u
              ? (d = u(s))
              : u instanceof RegExp && (d = u.test(s)),
            !0 !== d && (d = !1),
            (s = l(n, s)))
          ) {
            var p = { position: t, sourcePosition: e, source: c, isWhite: d }
            if (d) {
              var f = o(n, s, p)
              return r(f) ? n + ':' + s : f
            }
    ...
    function(e, t, n) {
      ...
      function a(e) {
        ;(e = o(e || {})),
          e.stripIgnoreTag &&
            (e.onIgnoreTag, (e.onIgnoreTag = l.onIgnoreTagStripAll)),
        ...
        var b = u(
          ...
          function(e, t, n, l, u) {
            ...
            if (m.isWhite) {
              ...
              var x = i(l),
                y = o[n],
                k = d(x.html, function(e, t) {
                  var i = -1 !== p.indexOf(y, e),
                    o = c(n, e, t, i)
                  if (!r(o)) return o
                  if (i) return (t = h(n, e, t, v)), t ? e + '="' + t + '"' : e
                  var o = f(n, e, t, i)
                  return r(o) ? void 0 : o
                }),
                l = '<' + n
              return k && (l += ' ' + k), x.closing && (l += ' /'), (l += '>')
            }
            var b = s(n, l, m)
            return r(b) ? g(l) : b
          },
